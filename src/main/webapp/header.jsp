...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <img src="./Pictures/sabiba_LOGO_sansBG.png" alt="logo" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none" width="80%" height="80%">

        <p class="justify-content-center">Sabiba SportShop</p>
        ...
        <div class="dropdown col-md-3 text-end">
            ...
            <ul class="dropdown-menu text-small shadow">
                <li><a class="dropdown-item" href="#" aria-current="page">Accueil</a></li>
                <li><a class="dropdown-item" href="#">Catégories de produit</a></li>
